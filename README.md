# 💫 About Me:
 👋 Hey, I'm Chandan <br>I’m currently deep-diving into Data Structures & Algorithms (DSA) using C++, sharpening my problem-solving skills.<br>At the same time, I’ve built solid expertise in JavaScript and completed learning the MERN Stack (MongoDB, Express.js, React.js, Node.js).<br><br>💻 What I’m Working On:<br>Practicing DSA regularly for better logic building<br><br>Building full-stack projects with MERN stack<br><br>Creating clean, responsive front-ends with React & Tailwind<br><br>Exploring TypeScript and advanced backend concepts
